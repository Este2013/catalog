            ...
            if (foundSectionsNb > 1)
              TabBar.secondary(
                tabs: [
                  ...
                  if (foundSections['constructors'] != null) Tab(text: 'Constructors'),
                  if (foundSections['properties'] != null) Tab(text: 'Properties'),
                  if (foundSections['implementation'] != null) Tab(text: 'Implementation'),
                ],
              ),
            Expanded(
              child: Padding(
