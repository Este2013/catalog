...
import 'base_classes_data/shape_borders.dart';
import 'widget_catalog.dart';

CatalogEntry physicalShapeCatalogEntry = BaseCatalogEntry(
  'PhysicalShape',
  icon: Icon(Symbols.shapes),
  widgetBuilder: (context, ctrl, variables) => PhysicalShape(
    color: variables['color'],
    clipper: ShapeBorderClipper(
      shape: shapeBorderFromChoiceData(variables['clipper\'s shape']),
    ),
  ...
  defaultParameters: [
    ...
    shapeBorderChoiceData('clipper\'s shape'),
  ],
);
